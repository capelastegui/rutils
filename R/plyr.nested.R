...
# llply.name(l,.fun=function(a,...,l.name){paste("Summary",a,l.name)}) resturns a list with 2 elements:
## 'a' (char "Summary 1 a"), and 'b' (char "Summary 2 b")
...
#   {
#     if(!is.null(myfun))
#     {myfun(l[[l.name]], ...,l.name=l.name)}else
#     {l[[l.name]]}
#   })
#   names(l1)<-names(l)
#   l1
...
# of level n, and a function .fun. Using list.ref as index, it navigates through the nested lists 
...
##delete-me: this is for test
#l.test<-list(a=list(a1=1,a2=2),b=list(b1=1,b2=2,b3=3))
